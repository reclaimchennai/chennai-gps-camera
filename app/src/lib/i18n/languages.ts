...
export interface CardStrings {
  ...
  wardPending: string;
  mock: string;
  /** Shown when the fix is too coarse to place the point in a ward. The
   *  ± distance is appended by the renderer. */
  approx: string;
  pincode: string;
}
...
export const LANGS: Record<CardLang, LangDef> = {
  en: {
    ...
    strings: {
      ...
      mock: "⚠ Mock location — GPS may be spoofed", approx: "⚠ Location approximate — ward may be wrong", pincode: "PIN",
    },
  },
  ta: {
    label: "தமிழ் Tamil",
    ...
    strings: {
      ...
      mock: "⚠ போலி இருப்பிடம் — GPS தவறாக இருக்கலாம்", approx: "⚠ இருப்பிடம் தோராயமானது — வார்டு தவறாக இருக்கலாம்", pincode: "அஞ்சல் குறியீடு",
    },
  },
  hi: {
    label: "हिन्दी Hindi",
    ...
    strings: {
      ...
      mock: "⚠ नकली स्थान — GPS गलत हो सकता है", approx: "⚠ स्थान अनुमानित — वार्ड गलत हो सकता है", pincode: "पिन कोड",
    },
  },
  kn: {
    label: "ಕನ್ನಡ Kannada",
    ...
    strings: {
      ...
      mock: "⚠ ನಕಲಿ ಸ್ಥಳ — GPS ತಪ್ಪಾಗಿರಬಹುದು", approx: "⚠ ಸ್ಥಳ ಅಂದಾಜು — ವಾರ್ಡ್ ತಪ್ಪಾಗಿರಬಹುದು", pincode: "ಪಿನ್ ಕೋಡ್",
    },
  },
  te: {
    label: "తెలుగు Telugu",
    ...
    strings: {
      ...
      mock: "⚠ నకిలీ స్థానం — GPS తప్పు కావచ్చు", approx: "⚠ స్థానం సుమారు — వార్డు తప్పు కావచ్చు", pincode: "పిన్ కోడ్",
    },
  },
  mr: {
    label: "मराठी Marathi",
    ...
    strings: {
      ...
      mock: "⚠ बनावट स्थान — GPS चुकीचे असू शकते", approx: "⚠ स्थान अंदाजे — प्रभाग चुकीचा असू शकतो", pincode: "पिन कोड",
    },
  },
  bn: {
    label: "বাংলা Bengali",
    ...
    strings: {
      ...
      mock: "⚠ নকল অবস্থান — GPS ভুল হতে পারে", approx: "⚠ অবস্থান আনুমানিক — ওয়ার্ড ভুল হতে পারে", pincode: "পিন কোড",
    },
  },
};
